...
[Obsolete("Please Use API_GSXR_Module_InputSystem_GGT26Dof")]
public class API_Module_InputSystem_GGT26Dof
{
    ...
    public static void EnableGGT(GGestureType type = GGestureType.Right) {
        if(GGT26DofDevice && type == GGestureType.Left) {
            ...
            GGT26DofDevice.SetActiveInputDevicePart(InputDevicePartType.HandLeft, true);
        } else if(GGT26DofDevice && type == GGestureType.Right) {
          
            GGT26DofDevice.SetActiveInputDevicePart(InputDevicePartType.HandRight, true);
        }
    }
    ...
    /// </summary>
    /// <param name="type"></param>
    public static void DisableGGT(GGestureType type = GGestureType.Right) {
        if(GGT26DofDevice && type == GGestureType.Left) {
         
            GGT26DofDevice.SetActiveInputDevicePart(InputDevicePartType.HandLeft, false);
        } else if(GGT26DofDevice && type == GGestureType.Right) {
          
            GGT26DofDevice.SetActiveInputDevicePart(InputDevicePartType.HandRight, false);
        }
    }
