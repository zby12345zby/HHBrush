...
[Obsolete("Please Use API_GSXR_Module_InputSystem_BT3Dof")]
public class API_Module_InputSystem_BT3Dof
{
    ...
    public static void EnableBT(BTType type = BTType.Right) {
        if(BTDevice && type == BTType.Right) {
            ...
            BTDevice.SetActiveInputDevicePart(InputDevicePartType.GCOne,true);

        } else if(BTDevice && type == BTType.Left) {
            //BTDevice.TwoGCActive = true;
            BTDevice.SetActiveInputDevicePart(InputDevicePartType.GCTwo, true);
        }
    }
    ...
    public static void DisableBT(BTType type = BTType.Right) {
        if(BTDevice && type == BTType.Right) {
            ...
            BTDevice.SetActiveInputDevicePart(InputDevicePartType.GCOne, false);
        } else if(BTDevice && type == BTType.Left) {
            //BTDevice.TwoGCActive = false;
            BTDevice.SetActiveInputDevicePart(InputDevicePartType.GCTwo, false);
        }
    }
