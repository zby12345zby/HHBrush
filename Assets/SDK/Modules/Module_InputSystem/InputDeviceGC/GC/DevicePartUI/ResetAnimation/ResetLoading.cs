    ...
    public class ResetLoading : SCModuleMono {
        ...
        public override void OnSCLateUpdate() {
            ...
            if(API_GSXR_Slam.SlamManager && API_GSXR_Slam.SlamManager.gameObject.activeSelf) {
                transform.position = API_GSXR_Slam.SlamManager.head.TransformPoint(loadingPosition);
                //transform.LookAt(API_GSXR_Slam.SlamManager.head);
                transform.eulerAngles = API_GSXR_Slam.SlamManager.head.eulerAngles + new Vector3(0, 0, -7);
            }
