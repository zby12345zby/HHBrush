...
namespace SC.XR.Unity.Module_InputSystem.InputDeviceHand {
    public class TouchCursor : DefaultCursor {
        ...
        [SerializeField]
        [Tooltip("Renderer representing the ring attached to the index finger using an Standard material with the round corner feature enabled.")]
        ...
        /// </summary>
        /// <param name="ringRenderer">Renderer using an Standard material with the round corner feature enabled.</param>
