...
namespace SC.XR.Unity.Module_InputSystem.InputDeviceHand {
    ...
    public class InputDevicePartDispatchEventHand : InputDevicePartDispatchEventBase {
        ...
        public InputDeviceHandPartFaceHead inputDeviceHandPartFaceHead;
        public InputDeviceHandPartFaceFlatHead inputDeviceHandPartFaceFlatHead;
        ...
        public InputDevicePartDispatchEventHand(InputDeviceHandPart inputDeviceHandPart) : base(inputDeviceHandPart) {
            ...
            eventList.Add(inputDeviceHandPartFaceHead = new InputDeviceHandPartFaceHead(this));
            eventList.Add(inputDeviceHandPartFaceFlatHead = new InputDeviceHandPartFaceFlatHead(this));
            //eventList.Add(inputDeviceHandPartFaceHeadCatch = new InputDeviceHandPartFaceHeadCatch(this));
