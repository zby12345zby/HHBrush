...
namespace SC.XR.Unity.Module_InputSystem {
    ...
    public abstract class PointerBase : SCModuleMono ,IPointer{
        ...
        public override void OnSCStart() {
            ...
            EnsureEventSystem();
            if (API_Module_Device.IsOtherDevice) {
                DebugMy.Log("Module_Device.AndroidDeviceType.Other: Close cursor Module",this,true);
            } else {
        ...
        protected virtual void UpdateSubVisual() {
            if (detectorBase.inputDevicePartBase.inputDataBase.SCPointEventData.DownPressGameObject || detectorBase.inputDevicePartBase.inputDataBase.SCPointEventData.pointerCurrentRaycast.gameObject != null) {
