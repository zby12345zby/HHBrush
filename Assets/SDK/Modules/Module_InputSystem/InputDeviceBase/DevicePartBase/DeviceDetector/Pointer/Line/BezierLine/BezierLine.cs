...
namespace SC.XR.Unity.Module_InputSystem {
    ...
    public class BezierLine : LineBase {
        ...
        public override void DrawLineIndicate() {
            ...
            bezierDataProvider.FirstPoint = transform.position;
            bezierDataProvider.LastPoint = pointerBase.cursorBase.transform.position - pointerBase.cursorBase.transform.rotation * new Vector3(0,0,0.05f);
        ...
        public override void UpdateTransform() {
            transform.position = pointerBase.transform.position + pointerBase.transform.rotation * new Vector3(0, 0, 0.1f);
