...
namespace SC.XR.Unity.Module_InputSystem.InputDeviceGC.KS {
    public class InputDataGetKSKey : InputDataGetGCKey {
        ...
        public override void OnSCStart() {
            ...
            } else if (inputDataGetKS.inputDeviceKSPart.inputDataGC.GCType == GCType.K07) {
                GetKeyModule = new GetK07Key(this);
            } else if (inputDataGetKS.inputDeviceKSPart.inputDataGC.GCType == GCType.Nolo) {
                GetKeyModule = new GetNoloKey(this);
            }
