    ...
    public class GetK101Key : SCModule {
        ...
        public override void OnSCAwake() {
            ...
            if (inputDataGetKSKey.inputDataGetKS.inputDeviceKSPart.PartType == InputDevicePartType.KSLeft) {
                ...
                if (API_Module_SDKConfiguration.HasKey("Module_InputSystem", "K101_Left_AnotherEnterKeyAlias")) {
                    InputKeyCode keyparse;
                    inputDataGetKSKey.inputDataGetKS.inputDeviceKSPart.inputDataGC.AnotherEnterKeyAlias = System.Enum.TryParse<InputKeyCode>(API_Module_SDKConfiguration.GetString("Module_InputSystem", "K101_Left_AnotherEnterKeyAlias", "NULL"), false, out keyparse) ? keyparse : InputKeyCode.NULL;
                }
                ...
                if (API_Module_SDKConfiguration.HasKey("Module_InputSystem", "K101_Right_AnotherEnterKeyAlias")) {
                    InputKeyCode keyparse;
                    inputDataGetKSKey.inputDataGetKS.inputDeviceKSPart.inputDataGC.AnotherEnterKeyAlias = System.Enum.TryParse<InputKeyCode>(API_Module_SDKConfiguration.GetString("Module_InputSystem", "K101_Right_AnotherEnterKeyAlias", "NULL"), false, out keyparse) ? keyparse : InputKeyCode.NULL;
                }
            }
