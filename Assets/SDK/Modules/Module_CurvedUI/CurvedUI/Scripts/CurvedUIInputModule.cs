...
#else
public class CurvedUIInputModule : SC.XR.Unity.Module_InputSystem.SCInputModule {
#endif
...
#region EVENT PROCESSING - UNITY XR
    ...
    static T EnableInputModule<T>() where T : BaseInputModule
    {
        ...
        if (eventGO == null)
        {
            ...
            eventGO = EventSystemObj.AddComponent<EventSystem>();
            //return null as T;
        }
