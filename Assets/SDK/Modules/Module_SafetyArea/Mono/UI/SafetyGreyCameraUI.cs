...
public class SafetyGreyCameraUI : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        this.transform.position = GSXRManager.Instance.head.position + GSXRManager.Instance.head.forward.normalized * 0.4f;
        this.transform.rotation = GSXRManager.Instance.head.transform.rotation;
