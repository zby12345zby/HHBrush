...
public class GSXRConfigOptions
{
    public static GSXRConfigOptions Instance
    {
        get
        {
            if (instance == null)
            {
                instance = new GSXRConfigOptions();
            }

            return instance;
        }
    }
    private static GSXRConfigOptions instance;
