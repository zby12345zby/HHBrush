...
public class GSXROverlay : MonoBehaviour, IComparable<GSXROverlay>
{
    public static List<GSXROverlay> Instances = new List<GSXROverlay>();
    ...
    public int CompareTo(GSXROverlay that)
    {
    ...
    void Start()
    {
        //Initialize(); Called by GSXRManager.InitializeOverlays()
    }
    ...
    void InitializeCameras()
    {
        ...
        foreach (var mainCamera in mainCameras)
        {
            ...
            if (frustumType == (int)GSXRManager.SlamSettings.eFrustumType.Device)
            {
