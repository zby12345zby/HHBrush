...
namespace TiltBrush
{
    ...
    public class CanvasScript : MonoBehaviour
    {
        ...
        // These bounds are for keeping values sane; they're not intended to be user-facing //这些界限是为了保持值的正常；它们不是面向用户的
        ...
        ///帮助获取和设置变换组件上的变换。
        //////转换本机允许您访问父相对（“本地”）
        //////以及位置、旋转和缩放的根相对（“全局”）视图。
        //////              ///此辅助对象提供变换的画布相对视图。
        //////语法上有点滥用C#：              ///
        //////传输xf\U CS=我的画布.AsCanvas[游戏对象转换]; 
        //////   我的画布.AsCanvas[游戏对象转换]=xf\u CS；
        //////              ///在唤醒时安全使用（）
