...
namespace TiltBrush
{
    ...
    {
        //public static Color _hideColor = new Color(255, 255, 255, 0);
        //private Color _normalLineColor;
        //private Color _dragLineColor;
        //private Color _quan_1_Color;
        //private Color _quan_2_Color;


        ////zbyAdd
        //public Material _normalLine;
        //public Material _dragLine;
        //public Material _quan_1;
        //public Material _quan_2;
        //public MeshRenderer _curorFocusRender;
        //public MeshRenderer _curorPressRender;
        //public MeshRenderer _curorFRestRender;
        ...
        void Awake()
        {
            ...
            //_normalLineColor = _normalLine.color;
            //_dragLineColor = _dragLine.color;
            //_quan_1_Color = _quan_1.color;
            //_quan_2_Color = _quan_2.color;
        ...
        void Start()
        {
            //_normalLine.color = _hideColor;
            //_dragLine.color = _hideColor;
            //_quan_1.color = _hideColor;
            //_quan_2.color = _hideColor;
            //_curorFocusRender.enabled = false;
            //_curorPressRender.enabled = false;
            //_curorFRestRender.enabled = false;
                                    ...
                                    if (aAllPanels[i].m_Panel.HasMeshCollider())
                                    {
                                        ...
                                        if (Vector3.Angle(aAllPanels[i].m_Panel.transform.forward, m_GazeControllerRay.direction) < m_GazeMaxAngleFromPointing)
                                        {
                                            ...
                                            if (Vector3.Angle(aAllPanels[i].m_Panel.transform.forward, vToPanel) < m_GazeMaxAngleFacingToForward)
                                            {
                                                ...
                                                {
                                                    Debug.Log("我被执行了");
                                                    //_normalLine.color = _normalLineColor;
                                                    //_dragLine.color = _dragLineColor;
                                                    //_quan_1.color = _quan_1_Color;
                                                    //_quan_2.color = _quan_2_Color;
                                                    //_curorFocusRender.enabled = true;
                                                    //_curorPressRender.enabled = true;
                                                    //_curorFRestRender.enabled = true;
