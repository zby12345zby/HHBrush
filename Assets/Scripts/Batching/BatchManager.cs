...
namespace TiltBrush
{
    ...
    {
        /// Leave this many batches per pool mutable//使每个池的批数保持可变
        ...
        /// Used by BatchPool and Batch to keep track of recent usage. ///由BatchPool和Batch用于跟踪最近的使用情况。
        ...
        // Returns a batch such that it has space for at least nVerts返回一个批处理，使其至少有空间容纳nVerts
        ...
        ///   ///笔刷-选择材料/批次              
        ///   ///nVerts-从主画笔复制的数量              
        ///   ///nTris-从MasterBrush.m\u Tris复制的金额
