...
namespace TiltBrush
{
    ...
    public class TiltBrushManifest : ScriptableObject
    {
        ...
        // The leading portion of the returned array will be == lhs.//lhs=lhs+rhs，删除重复项。              //返回数组的前导部分将是==lhs。
        ...
        /// Append the contents of rhs to this, eliminating duplicates///将rhs的内容附加到此文件，消除重复项
